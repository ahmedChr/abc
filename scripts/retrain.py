...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--image_dir',
      type=str,
      default='classificateur/tf_files/photos',
      help='Path to folders of labeled images.'
  )
  parser.add_argument(
      '--output_graph',
      type=str,
      default='classificateur/tf_files/retrained_graph.pb',
  ...
  parser.add_argument(
      '--output_labels',
      type=str,
      default='classificateur/tf_files/retrained_labels.txt',
      help='Where to save the trained graph\'s labels.'
  )
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default=f'classificateur/tf_files/training_summaries/{ARCHITECTURE}',
  ...
  parser.add_argument(
      '--model_dir',
      type=str,
      default=f'classificateur/tf_files/models/{ARCHITECTURE}',
      help="""\
  ...
  parser.add_argument(
      '--bottleneck_dir',
      type=str,
      default='classificateur/tf_files/bottlenecks',
